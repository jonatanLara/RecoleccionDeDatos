<section class="vh-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form>
          <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
            ...
            <button type="button" class="btn bg-primario bg-primario-hover btn-floating mx-1">
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <button type="button" class="btn bg-primario bg-primario-hover btn-lg"
  ...
  <div class="bg-primario d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5">
    ...
    <div class="text-white mb-3 mb-md-0">
      <p>Copyright © 2022. Reservados todos los derechos.</p>
    </div>
    <!-- Copyright -->
